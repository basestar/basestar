package io.basestar.maven.test.b;

@javax.validation.Valid
@io.basestar.mapper.annotation.ObjectSchema(name = "b.Test")
public class Test  {
    ...
    public int hashCode() {
        ...
        return java.util.Objects.hash(created, hash, id, updated, version, a, test);
    }
}
