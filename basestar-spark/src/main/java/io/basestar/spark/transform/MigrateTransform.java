...
//
//    public MigrateTransform(final ObjectSchema sourceSchema, final ObjectSchema targetSchema, final Migration migration) {
//
...
//
//        final ObjectSchema sourceSchema = this.sourceSchema;
