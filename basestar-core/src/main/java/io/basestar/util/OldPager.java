...
//
//    public OldPager(final Comparator<? super T> comparator, final List<Source<T>> sources, final Page.Token paging) {
//
//        this(comparator, sources, EnumSet.noneOf(Page.Stat.class), paging);
//    }
//
//    public OldPager(final Comparator<? super T> comparator, final List<Source<T>> sources, final Set<Page.Stat> stats, final Page.Token paging) {
//
...
//    }
//
//    public static <T> OldPager<T> merge(final Comparator<? super T> comparator, final Map<String, OldPager<T>> pagers) {
//        return null;
//    }
//
