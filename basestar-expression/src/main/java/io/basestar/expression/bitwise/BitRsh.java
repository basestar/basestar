...
@Data
public class BitRsh implements Binary {

    public static final String TOKEN = ">>";

    public static final int PRECEDENCE = BitLsh.PRECEDENCE;
    ...
    public BitRsh(final Expression lhs, final Expression rhs) {
...
//    }
    ...
    public <T> T visit(final ExpressionVisitor<T> visitor) {
        ...
        return visitor.visitBitRsh(this);
    }
