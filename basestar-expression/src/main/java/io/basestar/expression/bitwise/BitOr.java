...
@Data
public class BitOr implements Binary {

    public static final String TOKEN = "|";

    public static final int PRECEDENCE = BitXor.PRECEDENCE + 1;
    ...
    public BitOr(final Expression lhs, final Expression rhs) {
