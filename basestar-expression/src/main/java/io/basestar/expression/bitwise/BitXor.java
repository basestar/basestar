...
@Data
public class BitXor implements Binary {

    public static final String TOKEN = "^";

    public static final int PRECEDENCE = BitAnd.PRECEDENCE + 1;
    ...
    public BitXor(final Expression lhs, final Expression rhs) {
